...
fn synthetic_item(args: &PermissionsCheckArgs) -> Item {
    Item {
        ...
        tags: args.tags.clone(),
        vault: zad::service::onepass::client::VaultRef {
        ...
        fields: args
            ...
            .as_ref()
            .map(|f| {
                vec![zad::service::onepass::client::ItemField {
                    id: f.clone(),
                    label: f.clone(),
...
fn synthetic_item_for_ref(r: &ParsedOpRef, args: &PermissionsCheckArgs) -> Item {
    Item {
        ...
        fields: vec![zad::service::onepass::client::ItemField {
            id: r.field.clone(),
            label: r.field.clone(),
            field_type: String::new(),
            purpose: None,
