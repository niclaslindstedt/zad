...
use zad::config::{self, ProjectConfig};
...
pub trait LifecycleService: Send + Sync + 'static {
    ...
    /// Must match the entry in [`zad::service::registry::SERVICES`]
    ...
    /// Use [`zad::secrets::account`] to name each entry — do not
...
pub struct SecretRef {
    ...
    /// [`zad::secrets::store`]. User-visible identifier.
    pub account: String,
