...
fn example_for(path: &[&str]) -> Option<&'static str> {
    match path {
        ...
        ["github"] => Some("zad github issue list --repo myuser/sandbox"),
        ["github", "issue"] => Some("zad github issue list --repo myuser/sandbox --state open"),
        ["github", "pr"] => Some("zad github pr list --repo myuser/sandbox --state open"),
        ["github", "repo"] => Some("zad github repo view myuser/sandbox"),
        ["github", "file"] => Some("zad github file view --repo myuser/sandbox --path README.md"),
        ["github", "code"] => Some("zad github code search 'fn main extension:rs' --org myorg"),
        ["github", "run"] => Some("zad github run list --repo myuser/sandbox"),
        ["github", "permissions"] => Some("zad github permissions show"),
