...
| `commands [NAME]...` | Enumerate every CLI command, flag, and realistic example; also emits a JSON dump consumed by the pages extractor. | [`zad man commands`](commands.md) |
