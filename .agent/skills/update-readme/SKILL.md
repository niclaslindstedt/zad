...
`README.md` is the primary user-facing documentation for zad. It covers installation, quick start, the feature list, and any user-visible defaults. It goes stale whenever a CLI flag, subcommand, default, or supported surface changes without a matching edit.
