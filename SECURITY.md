...
Instead, please report privately via [GitHub Security Advisories](https://github.com/niclaslindstedt/zad/security/advisories/new),
...
In scope: any vulnerability in the published release of zad.
